...
proto.CreateOrderResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.CreateOrderResponse.repeatedFields_, null);
};
 ...
 * @const
 */
proto.CreateOrderRequest.repeatedFields_ = [3];
...
proto.CreateOrderRequest.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.OrderItem>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.OrderItem, 3));
};
...
proto.CreateOrderRequest.prototype.addItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.OrderItem, opt_index);
};
 ...
 * @const
 */
proto.CreateOrderResponse.repeatedFields_ = [2];
 ...
 * @return {!Array<string>}
 */
proto.CreateOrderResponse.prototype.getMessagesList = function() {
 ...
 * @return {!proto.CreateOrderResponse} returns this
 */
proto.CreateOrderResponse.prototype.setMessagesList = function(value) {
 ...
 * @return {!proto.CreateOrderResponse} returns this
 */
proto.CreateOrderResponse.prototype.addMessages = function(value, opt_index) {
 ...
 * @return {!proto.CreateOrderResponse} returns this
 */
proto.CreateOrderResponse.prototype.clearMessagesList = function() {
